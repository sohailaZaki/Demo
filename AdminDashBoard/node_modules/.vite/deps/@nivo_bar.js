...
var O = function(t2) {
  ...
  var y = o2, x3 = a2, m2 = C(o2, a2, n2, i2);
  if (b(t2)) {
...
var T = function(t2) {
  var n2 = t2.datum, o2 = t2.x, e3 = t2.y, r = t2.note, s = Et(), l = Zr(), u = l.animate, c = l.config, k4 = useSpring({ x: o2, y: e3, config: c, immediate: !u });
...
var D2 = function(t2) {
  var n2 = t2.x, i2 = t2.y, o2 = t2.size, e3 = void 0 === o2 ? k2.dotSize : o2, a2 = Et(), r = Zr(), s = r.animate, l = r.config, u = useSpring({ x: n2, y: i2, radius: e3 / 2, config: l, immediate: !s });
...
var L = function(t2) {
  var n2 = t2.x, i2 = t2.y, o2 = t2.width, e3 = t2.height, a2 = t2.borderRadius, r = void 0 === a2 ? 6 : a2, s = Et(), l = Zr(), u = l.animate, c = l.config, k4 = useSpring({ x: n2 - o2 / 2, y: i2 - e3 / 2, width: o2, height: e3, config: c, immediate: !u });
...
var J2 = function(e3) {
  ...
  return (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: i2.map(function(e4, i3) {
    ...
    return (0, import_jsx_runtime2.jsx)(X2, j3({}, r, { containerWidth: t2, containerHeight: a2, data: null != (l = r.data) ? l : o2, toggleSerie: r.toggleSerie && "keys" === r.dataFrom ? n2 : void 0 }), i3);
  }) });
};
var Q = ["data"];
var U = function(e3) {
  var t2, a2 = e3.bar, i2 = a2.data, l = q2(a2, Q), r = e3.style, o2 = r.borderColor, d = r.color, u = r.height, c = r.labelColor, s = r.labelOpacity, h = r.labelX, f = r.labelY, b2 = r.transform, v2 = r.width, g2 = e3.borderRadius, y = e3.borderWidth, w4 = e3.label, L3 = e3.shouldRenderLabel, C3 = e3.isInteractive, V2 = e3.onClick, M3 = e3.onMouseEnter, W2 = e3.onMouseLeave, T2 = e3.tooltip, B = e3.isFocusable, I2 = e3.ariaLabel, E3 = e3.ariaLabelledBy, H2 = e3.ariaDescribedBy, P2 = Et(), F = k(), X3 = F.showTooltipFromEvent, D3 = F.showTooltipAt, A = F.hideTooltip, G = (0, import_react2.useMemo)(function() {
    return function() {
    ...
    return X3(G(), e4);
  }, [X3, G]), K2 = (0, import_react2.useCallback)(function(e4) {
    null == M3 || M3(i2, e4), X3(G(), e4);
  }, [i2, M3, X3, G]), _2 = (0, import_react2.useCallback)(function(e4) {
    null == W2 || W2(i2, e4), A();
  }, [i2, A, W2]), J3 = (0, import_react2.useCallback)(function() {
    D3(G(), [l.absX + l.width / 2, l.absY]);
  }, [D3, G, l]), U2 = (0, import_react2.useCallback)(function() {
    A();
  }, [A]);
  return (0, import_jsx_runtime2.jsxs)(animated.g, { transform: b2, children: [(0, import_jsx_runtime2.jsx)(animated.rect, { width: to(v2, function(e4) {
    ...
    return Math.max(e4, 0);
  }), rx: g2, ry: g2, fill: null != (t2 = i2.fill) ? t2 : d, strokeWidth: y, stroke: o2, focusable: B, tabIndex: B ? 0 : void 0, "aria-label": I2 ? I2(i2) : void 0, "aria-labelledby": E3 ? E3(i2) : void 0, "aria-describedby": H2 ? H2(i2) : void 0, onMouseEnter: C3 ? K2 : void 0, onMouseMove: C3 ? N2 : void 0, onMouseLeave: C3 ? _2 : void 0, onClick: C3 ? z3 : void 0, onFocus: C3 && B ? J3 : void 0, onBlur: C3 && B ? U2 : void 0 }), L3 && (0, import_jsx_runtime2.jsx)(animated.text, { x: h, y: f, textAnchor: "middle", dominantBaseline: "central", fillOpacity: s, style: j3({}, P2.labels.text, { pointerEvents: "none", fill: c }), children: w4 })] });
};
var Z = ["color", "label"];
var $ = function(e3) {
...
var he = function(e3, t2, a2, i2) {
  ...
  return s.forEach(function(e4, a3) {
    return ce(0, h.domain().length).forEach(function(u2) {
      var s2, p2, y, x3 = re(n2[u2][e4]), S3 = x3[0], k4 = x3[1], w4 = o2(n2[u2]), L3 = (null != (s2 = h(w4)) ? s2 : 0) + t2 * a3 + c * a3, C3 = v2(p2 = k4, 0) ? null != (y = f(p2)) ? y : 0 : i2, V2 = function(e5, t3) {
        var a4;
        return v2(e5, 0) ? i2 - t3 : (null != (a4 = f(e5)) ? a4 : 0) - i2;
      }(k4, C3), M3 = { id: e4, value: null === S3 ? S3 : k4, formattedValue: l(k4), hidden: false, index: u2, indexValue: w4, data: g2[u2] };
      m2.push({ key: e4 + "." + M3.indexValue, index: m2.length, data: M3, x: L3, y: C3, absX: b2.left + L3, absY: b2.top + C3, width: t2, height: V2, color: r(M3), label: d(M3) });
    });
  }), m2;
};
var fe = function(e3, t2, a2, i2) {
  ...
  return u.forEach(function(e4, a3) {
    return ce(0, f.domain().length).forEach(function(u2) {
      var c2, p2, y, x3 = re(n2[u2][e4]), S3 = x3[0], k4 = x3[1], w4 = r(n2[u2]), L3 = v2(p2 = k4, 0) ? i2 : null != (y = h(p2)) ? y : 0, C3 = (null != (c2 = f(w4)) ? c2 : 0) + t2 * a3 + s * a3, V2 = function(e5, t3) {
        var a4;
      ...
      m2.push({ key: e4 + "." + M3.indexValue, index: m2.length, data: M3, x: L3, y: C3, absX: b2.left + L3, absY: b2.top + C3, width: V2, height: t2, color: o2(M3), label: d(M3) });
    });
  }), m2;
};
var be = function(e3) {
  ...
  }), y = ne(m2.data, p2), x3 = "vertical" === i2 ? ["y", "x", o2] : ["x", "y", d], S3 = x3[0], k4 = x3[1], w4 = x3[2], L3 = ie(y, m2.getIndex, c, b2, w4, k4), C3 = j3({ max: l, min: n2, reverse: r }, f), V2 = "auto" === C3.min ? se : function(e4) {
    return e4;
  }, M3 = y.reduce(function(e4, t3) {
    return [].concat(e4, p2.map(function(e5) {
      return t3[e5];
    }));
  }, []).filter(Boolean), W2 = V2(Math.min.apply(Math, M3)), T2 = (a2 = Math.max.apply(Math, M3), isFinite(a2) ? a2 : 0), B = cn(C3, { all: M3, min: W2, max: T2 }, "x" === S3 ? o2 : d, S3), I2 = "vertical" === i2 ? [L3, B] : [B, L3], O3 = I2[0], E3 = I2[1], R3 = (L3.bandwidth() - h * (p2.length - 1)) / p2.length, H2 = [j3({}, m2, { data: y, keys: p2, innerPadding: h, xScale: O3, yScale: E3 }), R3, C3.reverse, null != (t2 = B(0)) ? t2 : 0];
  return { xScale: O3, yScale: E3, bars: R3 > 0 ? "vertical" === i2 ? he.apply(void 0, H2) : fe.apply(void 0, H2) : [] };
};
...
var ye = function(e3) {
  var t2, a2 = e3.data, i2 = e3.layout, n2 = e3.minValue, l = e3.maxValue, r = e3.reverse, o2 = e3.width, d = e3.height, u = e3.padding, c = void 0 === u ? 0 : u, s = e3.valueScale, h = e3.indexScale, f = e3.hiddenIds, b2 = void 0 === f ? [] : f, v2 = q2(e3, ve), g2 = v2.keys.filter(function(e4) {
    ...
    return 0 !== e4;
  }) : t2), C3 = Math.min.apply(Math, L3), V2 = Math.max.apply(Math, L3), M3 = cn(w4, { all: L3, min: C3, max: V2 }, "x" === y ? o2 : d, y), W2 = "vertical" === i2 ? [k4, M3] : [M3, k4], T2 = W2[0], B = W2[1], I2 = v2.innerPadding > 0 ? v2.innerPadding : 0, O3 = k4.bandwidth(), E3 = [j3({}, v2, { innerPadding: I2, stackedData: m2, xScale: T2, yScale: B }), O3, w4.reverse];
  return { xScale: T2, yScale: B, bars: O3 > 0 ? "vertical" === i2 ? me.apply(void 0, E3) : pe.apply(void 0, E3) : [] };
};
var xe = function(e3) {
  var t2 = e3.bars, a2 = e3.direction, i2 = e3.from, n2 = e3.groupMode, r = e3.layout, o2 = e3.legendLabel, d = e3.reverse, u = Ii(null != o2 ? o2 : "indexes" === i2 ? "indexValue" : "id");
...
var Ce = function(e3) {
  var t2 = e3.indexBy, a2 = void 0 === t2 ? ee.indexBy : t2, i2 = e3.keys, l = void 0 === i2 ? ee.keys : i2, d = e3.label, u = void 0 === d ? ee.label : d, c = e3.tooltipLabel, s = void 0 === c ? ee.tooltipLabel : c, h = e3.valueFormat, f = e3.colors, b2 = void 0 === f ? ee.colors : f, v2 = e3.colorBy, g2 = void 0 === v2 ? ee.colorBy : v2, m2 = e3.borderColor, p2 = void 0 === m2 ? ee.borderColor : m2, y = e3.labelTextColor, S3 = void 0 === y ? ee.labelTextColor : y, L3 = e3.groupMode, C3 = void 0 === L3 ? ee.groupMode : L3, V2 = e3.layout, M3 = void 0 === V2 ? ee.layout : V2, W2 = e3.reverse, T2 = void 0 === W2 ? ee.reverse : W2, B = e3.data, I2 = e3.minValue, O3 = void 0 === I2 ? ee.minValue : I2, E3 = e3.maxValue, R3 = void 0 === E3 ? ee.maxValue : E3, H2 = e3.margin, P2 = e3.width, Y = e3.height, D3 = e3.padding, A = void 0 === D3 ? ee.padding : D3, G = e3.innerPadding, z3 = void 0 === G ? ee.innerPadding : G, N2 = e3.valueScale, q3 = void 0 === N2 ? ee.valueScale : N2, K2 = e3.indexScale, _2 = void 0 === K2 ? ee.indexScale : K2, J3 = e3.initialHiddenIds, Q2 = void 0 === J3 ? ee.initialHiddenIds : J3, U2 = e3.enableLabel, Z2 = void 0 === U2 ? ee.enableLabel : U2, $2 = e3.labelSkipWidth, te2 = void 0 === $2 ? ee.labelSkipWidth : $2, ae2 = e3.labelSkipHeight, ie2 = void 0 === ae2 ? ee.labelSkipHeight : ae2, ne2 = e3.legends, le2 = void 0 === ne2 ? ee.legends : ne2, re2 = e3.legendLabel, oe2 = e3.totalsOffset, de2 = void 0 === oe2 ? ee.totalsOffset : oe2, ue2 = (0, import_react2.useState)(null != Q2 ? Q2 : []), ce2 = ue2[0], se2 = ue2[1], he2 = (0, import_react2.useCallback)(function(e4) {
    ...
    return le2.map(function(e4) {
      return [e4, xe({ bars: "keys" === e4.dataFrom ? Re2 : Te2, direction: e4.direction, from: e4.dataFrom, groupMode: C3, layout: M3, legendLabel: re2, reverse: T2 })];
    });
  }, [le2, Re2, Te2, C3, M3, re2, T2]), Pe = (0, import_react2.useMemo)(function() {
...
var Ve = function(e3) {
  var t2 = e3.data, a2 = e3.springConfig, i2 = e3.animate, l = e3.layout, r = void 0 === l ? te.layout : l, o2 = Et();
...
var We2 = function(a2) {
  var i2 = a2.data, n2 = a2.indexBy, l = a2.keys, r = a2.margin, o2 = a2.width, d = a2.height, b2 = a2.groupMode, v2 = a2.layout, g2 = a2.reverse, m2 = a2.minValue, p2 = a2.maxValue, k4 = a2.valueScale, w4 = a2.indexScale, C3 = a2.padding, V2 = a2.innerPadding, M3 = a2.axisTop, W2 = a2.axisRight, T2 = a2.axisBottom, B = void 0 === T2 ? te.axisBottom : T2, I2 = a2.axisLeft, E3 = void 0 === I2 ? te.axisLeft : I2, R3 = a2.enableGridX, H2 = void 0 === R3 ? te.enableGridX : R3, P2 = a2.enableGridY, F = void 0 === P2 ? te.enableGridY : P2, X3 = a2.gridXValues, Y = a2.gridYValues, D3 = a2.layers, A = void 0 === D3 ? te.layers : D3, G = a2.barComponent, z3 = void 0 === G ? te.barComponent : G, N2 = a2.enableLabel, q3 = void 0 === N2 ? te.enableLabel : N2, K2 = a2.label, Q2 = a2.labelSkipWidth, U2 = void 0 === Q2 ? te.labelSkipWidth : Q2, Z2 = a2.labelSkipHeight, $2 = void 0 === Z2 ? te.labelSkipHeight : Z2, ee2 = a2.labelTextColor, ae2 = a2.markers, ie2 = void 0 === ae2 ? te.markers : ae2, ne2 = a2.colorBy, le2 = a2.colors, re2 = a2.defs, oe2 = void 0 === re2 ? te.defs : re2, de2 = a2.fill, ue2 = void 0 === de2 ? te.fill : de2, ce2 = a2.borderRadius, se2 = void 0 === ce2 ? te.borderRadius : ce2, he2 = a2.borderWidth, fe2 = void 0 === he2 ? te.borderWidth : he2, be2 = a2.borderColor, ve2 = a2.annotations, ge2 = void 0 === ve2 ? te.annotations : ve2, me2 = a2.legendLabel, pe2 = a2.tooltipLabel, ye2 = a2.valueFormat, xe2 = a2.isInteractive, Se2 = void 0 === xe2 ? te.isInteractive : xe2, ke2 = a2.tooltip, we2 = void 0 === ke2 ? te.tooltip : ke2, Le2 = a2.onClick, Me2 = a2.onMouseEnter, We3 = a2.onMouseLeave, Te2 = a2.legends, Be2 = a2.role, Ie2 = void 0 === Be2 ? te.role : Be2, Oe2 = a2.ariaLabel, Ee2 = a2.ariaLabelledBy, Re2 = a2.ariaDescribedBy, He2 = a2.isFocusable, Pe = void 0 === He2 ? te.isFocusable : He2, Fe = a2.barAriaLabel, Xe = a2.barAriaLabelledBy, Ye = a2.barAriaDescribedBy, De = a2.initialHiddenIds, Ae = a2.enableTotals, Ge = void 0 === Ae ? te.enableTotals : Ae, ze = a2.totalsOffset, Ne = void 0 === ze ? te.totalsOffset : ze, je = Zr(), qe = je.animate, Ke = je.config, _e = Bt(o2, d, r), Je = _e.outerWidth, Qe = _e.outerHeight, Ue = _e.margin, Ze = _e.innerWidth, $e = _e.innerHeight, et = Ce({ indexBy: n2, label: K2, tooltipLabel: pe2, valueFormat: ye2, colors: le2, colorBy: ne2, borderColor: be2, labelTextColor: ee2, groupMode: b2, layout: v2, reverse: g2, data: i2, keys: l, minValue: m2, maxValue: p2, margin: Ue, width: Ze, height: $e, padding: C3, innerPadding: V2, valueScale: k4, indexScale: w4, enableLabel: q3, labelSkipWidth: U2, labelSkipHeight: $2, legends: Te2, legendLabel: me2, initialHiddenIds: De, totalsOffset: Ne }), tt = et.bars, at = et.barsWithValue, it = et.xScale, nt = et.yScale, lt = et.getLabel, rt = et.getTooltipLabel, ot = et.getBorderColor, dt = et.getLabelColor, ut = et.shouldRenderBarLabel, ct = et.toggleSerie, st = et.legendsWithData, ht = et.barTotals, ft = useTransition(at, { keys: function(e3) {
    ...
    return { borderRadius: se2, borderWidth: fe2, enableLabel: q3, isInteractive: Se2, labelSkipWidth: U2, labelSkipHeight: $2, onClick: Le2, onMouseEnter: Me2, onMouseLeave: We3, getTooltipLabel: rt, tooltip: we2, isFocusable: Pe, ariaLabel: Fe, ariaLabelledBy: Xe, ariaDescribedBy: Ye };
  }, [se2, fe2, q3, rt, Se2, $2, U2, Le2, Me2, We3, we2, Pe, Fe, Xe, Ye]), vt = Vi(oe2, tt, ue2, { dataKey: "data", targetKey: "data.fill" }), gt = { annotations: null, axes: null, bars: null, grid: null, legends: null, markers: null, totals: null };
  A.includes("annotations") && (gt.annotations = (0, import_jsx_runtime2.jsx)(_, { bars: tt, annotations: ge2 }, "annotations")), A.includes("axes") && (gt.axes = (0, import_jsx_runtime2.jsx)(X, { xScale: it, yScale: nt, width: Ze, height: $e, top: M3, right: W2, bottom: B, left: E3 }, "axes")), A.includes("bars") && (gt.bars = (0, import_jsx_runtime2.jsx)(import_react2.Fragment, { children: ft(function(e3, t2) {
    return (0, import_react2.createElement)(z3, j3({}, bt, { bar: t2, style: e3, shouldRenderLabel: ut(t2), label: lt(t2.data) }));
  }) }, "bars")), A.includes("grid") && (gt.grid = (0, import_jsx_runtime2.jsx)(z, { width: Ze, height: $e, xScale: H2 ? it : null, yScale: F ? nt : null, xValues: X3, yValues: Y }, "grid")), A.includes("legends") && (gt.legends = (0, import_jsx_runtime2.jsx)(J2, { width: Ze, height: $e, legends: st, toggleSerie: ct }, "legends")), A.includes("markers") && (gt.markers = (0, import_jsx_runtime2.jsx)(Pi, { markers: ie2, width: Ze, height: $e, xScale: it, yScale: nt }, "markers")), A.includes("totals") && Ge && (gt.totals = (0, import_jsx_runtime2.jsx)(Ve, { data: ht, springConfig: Ke, animate: qe, layout: v2 }));
  var mt = (0, import_react2.useMemo)(function() {
    return j3({}, bt, { margin: Ue, width: o2, height: d, innerWidth: Ze, innerHeight: $e, bars: tt, legendData: st, enableLabel: q3, xScale: it, yScale: nt, tooltip: we2, getTooltipLabel: rt, onClick: Le2, onMouseEnter: Me2, onMouseLeave: We3 });
  }, [bt, Ue, o2, d, Ze, $e, tt, st, q3, it, nt, we2, rt, Le2, Me2, We3]);
  return (0, import_jsx_runtime2.jsx)(Oi, { width: Je, height: Qe, margin: Ue, defs: vt, role: Ie2, ariaLabel: Oe2, ariaLabelledBy: Ee2, ariaDescribedBy: Re2, isFocusable: Pe, children: A.map(function(e3, t2) {
    var a3;
...
var Te = function(e3) {
  ...
  return (0, import_jsx_runtime2.jsx)(Ht, { animate: n2, isInteractive: a2, motionConfig: r, renderWrapper: u, theme: o2, children: (0, import_jsx_runtime2.jsx)(We2, j3({ isInteractive: a2 }, c)) });
};
var Be = ["isInteractive", "renderWrapper", "theme"];
var Ie = function(e3, t2, a2, i2) {
  return e3.find(function(e4) {
    return Ui(e4.x + t2.left, e4.y + t2.top, e4.width, e4.height, a2, i2);
  });
};
var Oe = function(e3) {
  var t2 = e3.data, l = e3.indexBy, r = e3.keys, d = e3.margin, u = e3.width, s = e3.height, h = e3.groupMode, f = e3.layout, v2 = e3.reverse, g2 = e3.minValue, m2 = e3.maxValue, p2 = e3.valueScale, y = e3.indexScale, w4 = e3.padding, L3 = e3.innerPadding, C3 = e3.axisTop, T2 = e3.axisRight, E3 = e3.axisBottom, R3 = void 0 === E3 ? ae.axisBottom : E3, H2 = e3.axisLeft, F = void 0 === H2 ? ae.axisLeft : H2, X3 = e3.enableGridX, D3 = void 0 === X3 ? ae.enableGridX : X3, A = e3.enableGridY, G = void 0 === A ? ae.enableGridY : A, z3 = e3.gridXValues, N2 = e3.gridYValues, q3 = e3.layers, K2 = void 0 === q3 ? ae.layers : q3, _2 = e3.renderBar, J3 = void 0 === _2 ? function(e4, t3) {
    ...
    return { borderRadius: de2, borderWidth: ce2, isInteractive: pe2, isFocusable: false, labelSkipWidth: ee2, labelSkipHeight: ie2, margin: Fe, width: u, height: s, innerWidth: Xe, innerHeight: Ye, bars: ze, legendData: Ze, enableLabel: U2, xScale: je, yScale: qe, tooltip: xe2, getTooltipLabel: _e, onClick: Se2, onMouseEnter: ke2, onMouseLeave: we2 };
  }, [de2, ce2, pe2, ee2, ie2, Fe, u, s, Xe, Ye, ze, Ze, U2, je, qe, xe2, _e, Se2, ke2, we2]), lt = Dt(ge2);
  (0, import_react2.useEffect)(function() {
    ...
    Re2.current && t3 && (Re2.current.width = De * Me2, Re2.current.height = Ae * Me2, t3.scale(Me2, Me2), t3.fillStyle = He2.background, t3.fillRect(0, 0, De, Ae), t3.translate(Fe.left, Fe.top), K2.forEach(function(e5) {
      "grid" === e5 ? "number" == typeof He2.grid.line.strokeWidth && He2.grid.line.strokeWidth > 0 && (t3.lineWidth = He2.grid.line.strokeWidth, t3.strokeStyle = He2.grid.line.stroke, D3 && D(t3, { width: u, height: s, scale: je, axis: "x", values: z3 }), G && D(t3, { width: u, height: s, scale: qe, axis: "y", values: N2 })) : "axes" === e5 ? j(t3, { xScale: je, yScale: qe, width: Xe, height: Ye, top: C3, right: T2, bottom: R3, left: F, theme: He2 }) : "bars" === e5 ? Ne.forEach(function(e6) {
        ...
        var a2 = e6[0], i2 = e6[1];
        H(t3, j3({}, a2, { data: i2, containerWidth: Xe, containerHeight: Ye, theme: He2 }));
  ...
  }, [R3, F, T2, C3, Ne, de2, ce2, it, D3, G, Je, Ke, Qe, z3, N2, h, s, Ye, Xe, nt, K2, f, Ze, Fe.left, Fe.top, Ae, De, Me2, J3, je, qe, v2, Ue, He2, u, $e, Be2, lt]);
  var rt = (0, import_react2.useCallback)(function(e4) {
    if (ze && Re2.current) {
      var t3 = Xi(Re2.current, e4), a2 = t3[0], i2 = t3[1], n2 = Ie(ze, Fe, a2, i2);
  ...
  return (0, import_jsx_runtime2.jsx)("canvas", { ref: function(e4) {
    Re2.current = e4, We3 && "current" in We3 && (We3.current = e4);
...
var Ee = (0, import_react2.forwardRef)(function(e3, t2) {
  ...
  return (0, import_jsx_runtime2.jsx)(Ht, { isInteractive: a2, renderWrapper: i2, theme: n2, animate: false, children: (0, import_jsx_runtime2.jsx)(Oe, j3({}, l, { canvasRef: t2 })) });
});
var Re = function(e3) {
