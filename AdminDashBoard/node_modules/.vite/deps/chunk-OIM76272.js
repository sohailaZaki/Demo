...
var OutlinedInput = React75.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime51.jsx)(InputBase_default, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime51.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime50.jsxs)(React75.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
var FormControl3 = React78.forwardRef(function FormControl4(inProps, ref) {
  ...
  return (0, import_jsx_runtime54.jsx)(FormControlContext_default.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime54.jsx)(FormControlRoot, _extends({
      as: component,
      ownerState,
      className: clsx_default(classes.root, className),
      ref
...
var FormHelperText = React79.forwardRef(function FormHelperText2(inProps, ref) {
  ...
  return (0, import_jsx_runtime55.jsx)(FormHelperTextRoot, _extends({
    ...
    children: children === " " ? (
      // notranslate needed while Google Translate will not fix zero-width space issue
      _span6 || (_span6 = (0, import_jsx_runtime55.jsx)("span", {
        className: "notranslate",
        children: "​"
      }))
    ) : children
...
var Popover = React82.forwardRef(function Popover2(inProps, ref) {
  ...
  const getAnchorOffset = React82.useCallback(() => {
  ...
  const getTransformOrigin = React82.useCallback((elemRect) => {
    return {
      vertical: getOffsetTop(elemRect, transformOrigin.vertical),
      horizontal: getOffsetLeft(elemRect, transformOrigin.horizontal)
    };
  }, [transformOrigin.horizontal, transformOrigin.vertical]);
  const getPositioningStyle = React82.useCallback((element) => {
    const elemRect = {
  ...
  const [isPositioned, setIsPositioned] = React82.useState(open);
  const setPositioningStyles = React82.useCallback(() => {
  ...
  React82.useImperativeHandle(action, () => open ? {
    updatePosition: () => {
      setPositioningStyles();
    }
...
var Menu3 = React83.forwardRef(function Menu4(inProps, ref) {
  ...
  const menuListActionsRef = React83.useRef(null);
  const handleEntering = (element, isAppearing) => {
  ...
  let activeItemIndex = -1;
  React83.Children.map(children, (child, index2) => {
...
var TextField = React88.forwardRef(function TextField2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTextField"
  });
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-OIM76272.js.map
